    ...
    event.waitUntil(
        caches.open(CURRENT_CACHES['static']).then(function(cache) {
            return cache.addAll([
                ...
                '/img/sponsors/sponsor_50_kia_leuven.jpg',
                '/img/sponsors/sponsor_50_brantano.png',
                ...
                '/img/sponsors/sponsor_hoofd_kunstcollectief.png',
                '/img/sponsors/sponsor_hoofd_pxl.png',
                ...
                '/img/sponsors/sponsor_500_bettydupont.jpg',
                '/img/sponsors/sponsor_BlueBerryConsultancy.jpg',
